      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          {analysis && analysis.success && (
            <div className="mt-4">
              <div className="flex items-center mb-2">
                <LightBulbIcon className="h-5 w-5 text-blue-400 dark:text-blue-200 mr-1" />
                <span className="font-semibold text-gray-900 dark:text-white">Analysis Results</span>
              </div>
              <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded p-3 mb-2">
              ...
              {analysis.topicsOfInterest && analysis.topicsOfInterest.length > 0 && (
                <div className="mt-2">
                  <div className="flex items-center font-semibold text-sm mb-1 text-gray-900 dark:text-white">
                    <UserGroupIcon className="h-4 w-4 text-purple-400 dark:text-purple-200 mr-1" />
                    Topics of Interest
                  </div>
              ...
              {analysis.usagePatterns && (
                <div className="mt-2">
                  <div className="flex items-center font-semibold text-sm mb-1 text-gray-900 dark:text-white">
                    <ArrowPathIcon className="h-4 w-4 text-cyan-400 dark:text-cyan-200 mr-1" />
